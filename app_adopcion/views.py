...
from app_adopcion.models import Solicitud, Persona
from app_adopcion.forms import PersonaForm, SolicitudForm
...
class SolicitudEdit(UpdateView):
    model = Solicitud
    ...
    def get_context_data(self, **kwargs):
        context = super(SolicitudEdit, self).get_context_data(** kwargs)
